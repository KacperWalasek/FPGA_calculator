...
begin
 ...
 process is							-- proces bezwarunkowy
  ...
  begin								-- czesc wykonawcza procesu
    ...
    wait for O_ZEGARA;						-- dczekanie jeden okres zegara 'C'
    wait until WYSYLANIE='0';					-- czekanie az sygnal 'WYSYLANIE' przyjmie stan '0'
    SLOWO <= SLOWO + 7;						-- zwiekszenia wartosci 'SLOWO' o 7
   end process;							-- zakonczenie procesu
  
  uartl_tx_inst: entity work.uart_tx
    generic map (
    ...
    port map (
      ...
      SLOWO                => SLOWO,				-- wysylane slowo danych
      NADAJ                => NADAJ,				-- flaga zadania nadania
      WYSYLANIE            => WYSYLANIE				-- flaga zajetosci nadajnika
   );
